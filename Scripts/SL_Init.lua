...
SL = {
	...
	Preferences = {
		...
		PIU = {
			...
			PercentageScoring=true,
			AllowW1="AllowW1_Never",
			SubSortByNumSteps=true,

			TimingWindowSecondsW1=0.030000,
			TimingWindowSecondsW2=0.041600,
			TimingWindowSecondsW3=0.083200,
			TimingWindowSecondsW4=0.124800,
			TimingWindowSecondsW5=0.166400,
			TimingWindowSecondsHold=0.166400,
			TimingWindowSecondsMine=0.070000,
			TimingWindowSecondsRoll=0.166400,
		},
	},
	Metrics = {
		Casual = {
